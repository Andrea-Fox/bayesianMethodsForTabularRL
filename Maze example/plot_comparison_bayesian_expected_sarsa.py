...
dataframe_comparison = pd.read_csv("data/comparison_rewards_bayesian_expected_sarsa_q_value.csv")
dataframe_comparison_ext_prob = pd.read_csv("data/comparison_rewards_bayesian_step_expected_sarsa_external_prob.csv")
...
dataframe_comparison = dataframe_comparison.join(dataframe_comparison_ext_prob)
